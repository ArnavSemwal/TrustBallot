...
export default function LanguagePage() {
  ...
  const { setSelectedLanguage } = useKiosk();
  ...
  return (
    <div className="h-screen w-screen overflow-hidden flex flex-col bg-[#F9F9FB] text-[#0D233A] font-sans selection:bg-[#028090] selection:text-white select-none">
